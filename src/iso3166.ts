/**
 * ISO 3166-1 country reference — alpha-2 code, alpha-3 code, and official/common short name for
 * every currently assigned country code, plus a handful of very common informal names (e.g.
 * "USA", "UK", "South Korea") that aren't the official ISO short name but are what a caller is
 * likely to type. Used to validate the AI Birthcert template's optional `countryOfOrigin`
 * attribute against "ISO 3166 standard code or name" — see template-aliases.ts.
 */
...
/** Very common informal names that aren't the official ISO short name but are what callers type. */
...
/** True when `input` is a recognized ISO 3166-1 alpha-2/alpha-3 code, official name, or common informal name. */
